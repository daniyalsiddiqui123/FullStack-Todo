...
export default function TodoForm({ onTodoAdded }: TodoFormProps) {
  ...
  return (
    <div className="bg-card shadow-sm rounded-lg border border-border p-6">
      <h2 className="text-lg font-medium text-foreground mb-4">Create New Task</h2>
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div>
          ...
          <input
            ...
            className="block w-full px-3 py-2 border border-input rounded-md shadow-sm focus:outline-none focus:ring-ring focus:border-ring text-base text-foreground bg-background"
        ...
        <div>
          ...
          <textarea
            ...
            rows={3}
            className="block w-full px-3 py-2 border border-input rounded-md shadow-sm focus:outline-none focus:ring-ring focus:border-ring text-foreground bg-background"
